...
public class ModelPengembalian {
    ...
    public void kembali(String id, String nama, String kode, String tgl_pinjam, String tgl_kembali) {
      //  throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    java.sql.Connection con;
                    con = new KoneksiDatabase().connect();
                    String sql = "INSERT INTO `pengembalian`(`id`, `nama`, `kode`, `tgl_pinjam`, `tgl_kembali`) VALUES (?,?,?,?,?)";
